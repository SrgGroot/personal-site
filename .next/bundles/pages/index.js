...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_react_motion__ = __webpack_require__("./node_modules/react-motion/lib/react-motion.js");
...
var _jsxFileName = "D:\\Projects\\personal-site\\components\\layout.js";
...
(function () {
  ...
  reactHotLoader.register(_default, "default", "D:\\Projects\\personal-site\\components\\layout.js");
  leaveModule(module);
})();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_pose_core__ = __webpack_require__("./node_modules/pose-core/lib/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_pose_core___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_pose_core__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_popmotion_action__ = __webpack_require__("./node_modules/popmotion/action/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_popmotion_action___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_popmotion_action__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_stylefire__ = __webpack_require__("./node_modules/stylefire/dist/stylefire.es.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_popmotion_reactions_value__ = __webpack_require__("./node_modules/popmotion/reactions/value.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_popmotion_reactions_value___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_popmotion_reactions_value__);
...
var linear = __WEBPACK_IMPORTED_MODULE_0_popmotion__["d" /* easing */].linear;
var interpolate = __WEBPACK_IMPORTED_MODULE_0_popmotion__["h" /* transform */].interpolate;
var singleAxisPointer = function (axis) { return function (from) {
    return Object(__WEBPACK_IMPORTED_MODULE_0_popmotion__["f" /* pointer */])((_a = {}, _a[axis] = from, _a)).pipe(function (v) { return v[axis]; });
    var _a;
}; };
...
var underDampedSpring = function (_a) {
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_0_popmotion__["g" /* spring */])({
        from: from,
        to: to,
        velocity: velocity,
        stiffness: 500,
...
var overDampedSpring = function (_a) {
    var from = _a.from, velocity = _a.velocity, to = _a.to;
    return Object(__WEBPACK_IMPORTED_MODULE_0_popmotion__["g" /* spring */])({ from: from, to: to, velocity: velocity, stiffness: 700, damping: to === 0 ? 100 : 35 });
};
var linearTween = function (_a) {
    var from = _a.from, to = _a.to;
    return Object(__WEBPACK_IMPORTED_MODULE_0_popmotion__["i" /* tween */])({ from: from, to: to, ease: linear });
};
var intelligentTransition = eachValue({
    ...
    opacity: linearTween,
    default: __WEBPACK_IMPORTED_MODULE_0_popmotion__["i" /* tween */]
});
...
var createPassiveValue = function (init, parent, transform$$1) {
    var raw = Object(__WEBPACK_IMPORTED_MODULE_0_popmotion__["j" /* value */])(init).pipe(transform$$1);
    parent.raw.subscribe(raw);
    return { raw: raw };
};
var createValue = function (init) {
    var type = valueTypeTests.find(testValueType(init));
    var raw = Object(__WEBPACK_IMPORTED_MODULE_0_popmotion__["j" /* value */])(type === __WEBPACK_IMPORTED_MODULE_1_style_value_types__["number"] ? type.parse(init) : init);
...
var pose = function (_a) {
    ...
    return __WEBPACK_IMPORTED_MODULE_2_pose_core___default()({
        ...
        addActionDelay: function (delay$$1, transition) {
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_0_popmotion__["b" /* chain */])(Object(__WEBPACK_IMPORTED_MODULE_0_popmotion__["c" /* delay */])(delay$$1), transition);
        },
...
var createDimensions = (function (element) {
    ...
    return {
        ...
        measurementAsPixels: function (measurement, value$$1, type) {
            return type === __WEBPACK_IMPORTED_MODULE_1_style_value_types__["percent"] && typeof value$$1 === 'number'
...
var makeDraggable = function (element, activeActions, setPose, _a) {
    ...
    var dragStartListener = Object(__WEBPACK_IMPORTED_MODULE_0_popmotion__["e" /* listen */])(element, 'mousedown touchstart').start(function (startEvent) {
        startEvent.preventDefault();
        setPose('dragging');
        if (onDragStart)
            onDragStart(startEvent);
        var dragEndListener = Object(__WEBPACK_IMPORTED_MODULE_0_popmotion__["e" /* listen */])(document, 'mouseup touchend').start(function (endEvent) {
...
var setValue = function (_a, key, to) {
    ...
    if (values.has(key)) {
        ...
        values.set(key, {
            raw: Object(__WEBPACK_IMPORTED_MODULE_0_popmotion__["j" /* value */])(to, function (v) { return props.elementStyler.set(key, v); })
        });
    }
};
...
var createPoseConfig = function (element, _a) {
    ...
    var poseConfig = __assign({ flip: {} }, config, { props: __assign({}, config.props, { draggable: draggable,
            ...
            element: element, elementStyler: Object(__WEBPACK_IMPORTED_MODULE_4_stylefire__["a" /* default */])(element, { preparseOutput: false }), dimensions: createDimensions(element) }) });
    if (draggable) {
...
/***/ "./node_modules/popmotion/action/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
var chainable_1 = __webpack_require__("./node_modules/popmotion/chainable/index.js");
var observer_1 = __webpack_require__("./node_modules/popmotion/observer/index.js");
...
/***/ "./node_modules/popmotion/calc.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/popmotion/chainable/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var transformers_1 = __webpack_require__("./node_modules/popmotion/transformers.js");
...
/* unused harmony export physics */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return index$2; });
/* unused harmony export timeline */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return tween; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return listen; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return index$3; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return transformers; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_stylefire__ = __webpack_require__("./node_modules/stylefire/dist/stylefire.es.js");
/* unused harmony reexport styler */
...
var smooth$1 = function (strength) {
    ...
    var lastUpdated = 0;
    return function (v) {
        var currentFramestamp = Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["currentFrameTime"])();
...
var ValueReaction = /*#__PURE__*/function (_super) {
    ...
    function ValueReaction(props) {
        ...
        _this.scheduleVelocityCheck = function () {
            return Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["onFrameEnd"])(_this.velocityCheck);
        };
        _this.velocityCheck = function () {
            if (Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["currentFrameTime"])() !== _this.lastUpdated) {
    ...
    ValueReaction.prototype.update = function (v) {
        ...
        this.timeDelta = Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["timeSinceLastFrame"])();
        this.lastUpdated = Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["currentFrameTime"])();
        Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["onFrameEnd"])(this.scheduleVelocityCheck);
    };
                ...
                return a.start({
                    complete: function () {
                        if (!hasCompleted) {
                            hasCompleted = true;
                            numCompletedActions++;
                            if (numCompletedActions === numActions) Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["onFrameUpdate"])(complete);
                        }
                    },
                    error: error,
                    update: function (v) {
                        setProp(output, name, v);
                        Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["onFrameUpdate"])(updateOutput, true);
                    }
                });
            });
...
var isColor = __WEBPACK_IMPORTED_MODULE_2_style_value_types__["color"].test;
var convertToColorAction = function (init, props) {
    return typeof props.from === 'string' && isColor(props.from) && typeof props.to === 'string' && isColor(props.to) ? init(Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["a" /* __assign */])({}, props, { from: 0, to: 1 })).pipe(blendColor(props.from, props.to), __WEBPACK_IMPORTED_MODULE_2_style_value_types__["color"].transform) : init(props);
};
...
var createArrayVector = function (init, props, vectorKeys) {
    ...
    var actionList = props[firstVectorKey].map(function (v, i) {
        return convertToColorAction(init, vectorKeys.reduce(reduceArrayValue(i), Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["a" /* __assign */])({}, props)));
    });
...
var createObjectVector = function (init, props, vectorKeys) {
    ...
    var actionMap = Object.keys(props[firstVectorKey]).reduce(function (map, key) {
        map[key] = convertToColorAction(init, vectorKeys.reduce(reduceObjectValue(key), Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["a" /* __assign */])({}, props)));
        return map;
    }, {});
...
var frame = function () {
    return action(function (_a) {
        var update = _a.update;
        var isActive = true;
        var startTime = Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["currentTime"])();
        var nextFrame = function () {
            if (!isActive) return;
            update(Math.max(Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["currentFrameTime"])() - startTime, 0));
            Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["onFrameUpdate"])(nextFrame);
        };
        Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["onFrameUpdate"])(nextFrame);
        return {
            stop: function () {
...
var decay = function (props) {
    ...
    return action(function (_a) {
        ...
        var timer = frame().start(function () {
            elapsed += Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["timeSinceLastFrame"])();
    ...
    return action(function (_a) {
        ...
        var startTimer = function () {
            ...
            tweenTimer = frame().start(function () {
                elapsed += Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["timeSinceLastFrame"])() * playDirection;
                updateTween();
                if (isTweenComplete() && complete) {
                    tweenTimer.stop();
                    Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["onFrameUpdate"])(complete, true);
                }
            });
        };
        ...
        return {
            ...
            seek: function (newProgress) {
                ...
                Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["onFrameUpdate"])(updateTween, true);
                return this;
            },
            reverse: function () {
                reverseTween();
...
var physics = function (props) {
    ...
    return action(function (_a) {
        ...
        var current = from;
        var timer = frame().start(function () {
            var elapsed = Math.max(Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["timeSinceLastFrame"])(), 16);
...
var spring = function (props) {
    ...
    return action(function (_a) {
        ...
        var springTimer = frame().start(function () {
            var timeDelta = Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["timeSinceLastFrame"])();
            t += timeDelta;
...
var multitouch = function (_a) {
    ...
    return action(function (_a) {
        ...
        var onMove = function (e) {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["onFrameUpdate"])(updatePoint);
        };
        var updateOnMove = listen(document, 'touchmove', { passive: !preventDefault }).start(onMove);
        if (isTouchDevice) Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["onFrameUpdate"])(updatePoint);
        return {
            stop: function () {
                Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["cancelOnFrameUpdate"])(updatePoint);
                updateOnMove.stop();
            }
        };
    });
...
var mouse = function (_a) {
    ...
    return action(function (_a) {
        ...
        if (isMouseDevice) Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["onFrameUpdate"])(updatePoint);
        return {
            stop: function () {
                Object(__WEBPACK_IMPORTED_MODULE_1_framesync__["cancelOnFrameUpdate"])(updatePoint);
                updateOnMove.stop();
...
var css = function (element, props) {
    Object(__WEBPACK_IMPORTED_MODULE_4_hey_listen__["warning"])(false, 'css() is deprecated, use styler instead');
    return Object(__WEBPACK_IMPORTED_MODULE_3_stylefire__["a" /* default */])(element, props);
};
var svg = function (element, props) {
    Object(__WEBPACK_IMPORTED_MODULE_4_hey_listen__["warning"])(false, 'svg() is deprecated, use styler instead');
    return Object(__WEBPACK_IMPORTED_MODULE_3_stylefire__["a" /* default */])(element, props);
};
...
/***/ "./node_modules/popmotion/observer/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/popmotion/reactions/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/popmotion/reactions/value.js":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var framesync_1 = __webpack_require__("./node_modules/framesync/dist/framesync.es.js");
var calc_1 = __webpack_require__("./node_modules/popmotion/calc.js");
var _1 = __webpack_require__("./node_modules/popmotion/reactions/index.js");
...
/***/ "./node_modules/popmotion/transformers.js":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var framesync_1 = __webpack_require__("./node_modules/framesync/dist/framesync.es.js");
var style_value_types_1 = __webpack_require__("./node_modules/style-value-types/dist/style-value-types.es.js");
var calc_1 = __webpack_require__("./node_modules/popmotion/calc.js");
...
/***/ "./node_modules/pose-core/lib/factories/setter.js":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var selectors_1 = __webpack_require__("./node_modules/pose-core/lib/inc/selectors.js");
...
/***/ "./node_modules/pose-core/lib/factories/transitions.js":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var hey_listen_1 = __webpack_require__("./node_modules/hey-listen/dist/hey-listen.es.js");
...
/***/ "./node_modules/pose-core/lib/factories/values.js":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var selectors_1 = __webpack_require__("./node_modules/pose-core/lib/inc/selectors.js");
var setter_1 = __webpack_require__("./node_modules/pose-core/lib/factories/setter.js");
...
/***/ "./node_modules/pose-core/lib/inc/selectors.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/pose-core/lib/inc/transition-composers.js":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var setter_1 = __importDefault(__webpack_require__("./node_modules/pose-core/lib/factories/setter.js"));
var values_1 = __importDefault(__webpack_require__("./node_modules/pose-core/lib/factories/values.js"));
var transitions_1 = __importDefault(__webpack_require__("./node_modules/pose-core/lib/factories/transitions.js"));
var transition_composers_1 = __webpack_require__("./node_modules/pose-core/lib/inc/transition-composers.js");
...
/***/ "./node_modules/react-pose/lib/components/PoseElement.js":
/***/ (function(module, exports, __webpack_require__) {
...
var react_1 = __webpack_require__("./node_modules/react/cjs/react.development.js");
var popmotion_pose_1 = __webpack_require__("./node_modules/popmotion-pose/dist/popmotion-pose.es.js");
var hey_listen_1 = __webpack_require__("./node_modules/hey-listen/dist/hey-listen.es.js");
...
/***/ "./node_modules/react-pose/lib/components/PoseGroup.js":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__("./node_modules/react/cjs/react.development.js");
var children_1 = __webpack_require__("./node_modules/react-pose/lib/utils/children.js");
...
Object.defineProperty(exports, "__esModule", { value: true });
var posed_1 = __webpack_require__("./node_modules/react-pose/lib/posed.js");
var PoseGroup_1 = __webpack_require__("./node_modules/react-pose/lib/components/PoseGroup.js");
...
/***/ "./node_modules/react-pose/lib/posed.js":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__("./node_modules/react/cjs/react.development.js");
var PoseElement_1 = __webpack_require__("./node_modules/react-pose/lib/components/PoseElement.js");
var supported_elements_1 = __webpack_require__("./node_modules/react-pose/lib/utils/supported-elements.js");
...
/***/ "./node_modules/react-pose/lib/utils/children.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/react-pose/lib/utils/supported-elements.js":
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_style_value_types__ = __webpack_require__("./node_modules/style-value-types/dist/style-value-types.es.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_hey_listen__ = __webpack_require__("./node_modules/hey-listen/dist/hey-listen.es.js");
    ...
    return function (props) {
        ...
        var setValue = function (unmappedKey, value) {
            ...
            if (state[key] !== currentValue) {
                ...
                if (!hasChanged) {
                    hasChanged = true;
                    Object(__WEBPACK_IMPORTED_MODULE_0_framesync__["onFrameRender"])(render);
                }
            }
        };
...
var createDOMStyler = function (node, props) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_2_hey_listen__["invariant"])(styler !== undefined, 'No valid node provided. Node must be HTMLElement, SVGElement or window.');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_react_motion__ = __webpack_require__("./node_modules/react-motion/lib/react-motion.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_react_motion___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_react_motion__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_react_pose__ = __webpack_require__("./node_modules/react-pose/lib/index.js");
...
var _jsxFileName = "D:\\Projects\\personal-site\\pages\\index.js";
...
var CreateIndex = function CreateIndex(props) {
  ...
  component.render = function () {
    return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", {
      ...
      className: "jsx-1963203344"
    }), component.state.body)), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_0_styled_jsx_style___default.a, {
      styleId: "1963203344",
      css: "div.jsx-1963203344{font:23px Times,Arial,sans-serif;}.message.jsx-1963203344{text-align:center;padding-top:50px;}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=pages\\index.js */"
    }));
  };
...
(function () {
  ...
  reactHotLoader.register(CreateIndex, "CreateIndex", "D:\\Projects\\personal-site\\pages\\index.js");
  reactHotLoader.register(_default, "default", "D:\\Projects\\personal-site\\pages\\index.js");
  leaveModule(module);
})();
